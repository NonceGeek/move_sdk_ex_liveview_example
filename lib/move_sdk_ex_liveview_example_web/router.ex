defmodule MoveSDKExLiveviewExampleWeb.Router do
  use MoveSDKExLiveviewExampleWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {MoveSDKExLiveviewExampleWeb.LayoutView, :root}
  ...
  scope "/", MoveSDKExLiveviewExampleWeb do
    ...
    live "/", ExampleAptosLive, :index
    live "/starcoin", ExampleStarcoinLive, :index
  ...
  # scope "/api", MoveSDKExLiveviewExampleWeb do
  #   pipe_through :api
  # end
